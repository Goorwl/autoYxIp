...
echo.
echo ========================================================
echo 2. 开始本地测速 (测试延迟与丢包，选取前 50 个最优节点)...
echo ========================================================
